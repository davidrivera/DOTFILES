...
function print_net(name, down, up)
        return '<span color="#CC9393">' .. down .. '</span> <span color="#7F9F7F">' .. up  .. '</span>'
end
...
beautiful.init("/home/david/.config/awesome/default/theme.lua")
...
mytextclock = awful.widget.textclock({ align = "right" }, "%A %B %d %Y, %I:%M:%S %p", 1)
