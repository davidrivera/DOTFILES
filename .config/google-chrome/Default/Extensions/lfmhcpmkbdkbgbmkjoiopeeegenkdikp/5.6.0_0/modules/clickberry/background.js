...
function insertYoutubeExtension(tabId) {
	...
	canInsert( function( can ){
	    ...
	    if (onClickberryState) {
	        ...
	        var url     =   chrome.extension.getURL("modules/clickberry/ChromeStdInjector.js")+"?v="+config.name+"&addonType=standalone";
...
chrome.webRequest.onBeforeRequest.addListener(
    function(details) { 
        ...
        if (state && details.url.toString().indexOf("list=") === -1) {
