(function(){
	...
	function displayRateMessage( type ) {
		...
		{
			var addon_title = "New YouTube Features";
			var first_line = "Check out the new social tagging features";
			var second_line = " now available from ClickBerry!";
			var third_line = null;
			var button_title = "Show Me Now";
