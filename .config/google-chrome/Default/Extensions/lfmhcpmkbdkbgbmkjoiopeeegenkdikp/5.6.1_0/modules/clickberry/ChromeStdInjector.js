...
//                tagButton.style["margin-top"]       =   (Clickberry.CBYTPlayer.html5)?(ClickBerryTagger.playerContainer.clientHeight-22)+"px":"-22px";
    ...
    var replaceContainer = function(container, videoLink, autoPlay, overlay) {
        ...
        if (v === "auto") {
            src = 'https://auto.clickberry.tv/extension/?productName=ClickBerry%20YouTube%20Extension&externalVideoLink=' + encodeURIComponent(videoLink) + '&width=' + width + '&height=' + height + '&left=' + wndLeft + '&top=' + wndTop + '&wndID=' + wndID + '&autoPlay=' + autoPlay + '&acsNamespace=clickautosus&addonType='+addonType+'&embed='+embed;
        }
