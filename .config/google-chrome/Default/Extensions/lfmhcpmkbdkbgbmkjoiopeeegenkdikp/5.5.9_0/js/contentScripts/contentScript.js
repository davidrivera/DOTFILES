(function(){
	...
	const DONT_DISPLAY_AGAIN = "Don't show it again";

	// ======================  RATE  ==============================================================
	function displayRateMessage( type ) {
	
		var message = document.getElementById( RATE_MESSAGE_ID );
	
		if (type == "twitter")
		{
			var addon_title = "Vines Video Compilation App";
			var first_line = "Check out our new Vine Video App from";
			var second_line = "FVD Downloader Team on Chrome Webstore!";
			var third_line = null;
			var button_title = "View App";
			var url = "https://chrome.google.com/webstore/detail/vines-compilation/aofbadhekfmdddiihifojhjjpkaoojkn?hl=en-US";
		}
		else if (type == "instagram")
		{
			var addon_title = "Instagram Videos App";
			var first_line = " Check out our new Instagram Videos App from ";
			var second_line = "FVD Downloader Team on Chrome Webstore!";
			var third_line = null;
			var button_title = "View App";
			var url = "https://chrome.google.com/webstore/detail/instagram-video-compilati/pkjgkpkhpnpfgldmkimppnbpfnbkoibe";
		}
		else if (type == "vine")
		{
			var addon_title = "Vines Video Compilation App";
		...
		{
			var addon_title = "New YouTube Feature";
			var first_line = "Check out this new Super feature for YouTube from ClickBerry.";
			var second_line = "Now you can add EMOJI, Text Comments and Facebook";
			var third_line = "Likes inside Youtube videos you watch.";
			var button_title = "Check this out";
			var url = "http://get.clickberry.com/youtube-enhance/";
		}
		...
		{		
			...
			div2.setAttribute("style", "margin-top:15px;");
			...
			div4a = document.createElement("a");
			div4a.setAttribute("class", "button_concealed");
			div4a.setAttribute("style", "text-decoration: none;");
			div4a.innerHTML = '<span>'+button_title+' >></span>';
			div4.appendChild( div4a );	
			div4a.addEventListener( "click", _click, false );
			
			div5 = document.createElement("div");
			div5.setAttribute("class", "dontshow");
			div5.innerHTML = '<label><input type="checkbox"><strong>'+DONT_DISPLAY_AGAIN+'</strong></label>';
			div.appendChild( div5 );	

			message.querySelector(".dontshow").addEventListener("click", function(){

								chrome.extension.sendRequest( {
													akce:"dontDisplayRateMessage",  
													type: type  
												},	
												function( response ){ 		
											} );
		...
		if( !document.getElementById( BUTTON_ID_DM ) )
			{
				...
				if( elemFlag )
				{
					...
					elemB.parentNode.insertBefore(dv, elemB);
				}
				else
				{
