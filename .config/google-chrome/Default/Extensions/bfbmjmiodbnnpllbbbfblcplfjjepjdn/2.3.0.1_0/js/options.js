...
nightDomains = JSON.stringify({'http://www.youtube.com': true, 'http://www.nytimes.com': true});
...
$("nightmovebutton").addEventListener('click', function() {nightSelectedExcludedDomain();});
