...
$('#reset_form').submit(function (evt) {
    ...
    $.ajax({
      type: "POST",
      url: "/password-reset",
      beforeSend: function (xhr) { xhr.setRequestHeader ("Authorization", "Basic " + basic_auth); },
      data: json,
      success: function(msg){
            $('#reset_alert').html('<p class="no_error">Your password has been changed. You can sign in to <a href="https://web.tweetdeck.com">the web app</a> or in your client.</p>');
